...
import { Car, ShieldCheck, Headphones, Sparkles, Users, Trophy } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <section className="text-center space-y-4 mb-10">
          ...
          <p className="text-lg text-dark-600 max-w-3xl mx-auto">
            CarNation helps you rent and buy cars with clarity, transparent pricing, and delightful support.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-10">
          {[
            { icon: ShieldCheck, title: "Trusted", desc: "Verified owners, secure payments, safe experience." },
            { icon: Sparkles, title: "Quality", desc: "Curated listings, transparent details, no surprises." },
            { icon: Headphones, title: "Support", desc: "Fast assistance from booking to handover." },
            { icon: Trophy, title: "Value", desc: "Fair pricing, seasonal offers, and rewards." },
          ].map((h, i) => (
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {[
              { year: "2023", title: "Founded CarNation", desc: "Started with a simple mission: make car access effortless." },
              { year: "2024", title: "Launched Rentals", desc: "Expanded across major metro cities with curated inventory." },
              { year: "2025", title: "Buy & Sell", desc: "Verified used cars with transparent history and support." },
            ].map((t, i) => (
        ...
        {/* Team */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-dark-900 mb-4">Meet the Team</h2>
        ...
        <section className="text-center">
          <a href="/rent" className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-primary text-white font-bold shadow-md hover:shadow-lg">
